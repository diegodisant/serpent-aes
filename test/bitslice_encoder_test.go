...
func TestBitSliceEncrypt(test *testing.T) {
	...
	var encryptedText t.Bitstring = serpent.EncryptBitSlice(plainText, serpent.MakeLongKey(plainTextKey))
...
func TestBitSliceDecrypt(test *testing.T) {
	var serpent s.Serpent
	...
	var decryptedText t.Bitstring = serpent.DecryptBitSlice(encryptedText, serpent.MakeLongKey(plainTextKey))
